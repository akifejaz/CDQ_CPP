...
enum login{ loginSuccess ,loginFailed};                      //flags for login
enum functions{ updateDatabase, searchDatabase, deleteFromDatabase, displayDatabase, addToDatabase}; //flags for functions
enum status {serverConnFailed,socketCreated, socketCreationFailed, userNameIncorrect, passwordIncorrect, invalidFunction}; //flags for login
...
flags f ; login l; status lfd; functions fun;  //flags and login for user and admin
